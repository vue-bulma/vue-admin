...
export default {
  ...
  route: {
    data () {
      return this.$http.get('https://raw.githubusercontent.com/plotly/datasets/master/2014_us_cities.csv')
      .then(({ data }) => Plotly.d3.csv.parseRows(data))
    }
  },
  ...
  ready () {
    ...
    Plotly.plot(this.$els.map, data, layout, { showLink: false })
  },
